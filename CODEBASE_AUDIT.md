...
- 最近复核窗口（2026-09-15 架构评审复核轮）：`3c06840..fb217b5` 13 提交，HEAD `fb217b5`（对象为评审报告已落地候选的独立复核 + 复核发现的问题按序修复；新立案 1 项 AUD-PERF-008 并同日解决）
