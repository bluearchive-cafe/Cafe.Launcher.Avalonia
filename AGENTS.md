...
- `Services/HttpClientFactory` owns shared pooled handlers and hands out proxy-aware leases; do not create ad-hoc `HttpClient` instances or long-lived handlers elsewhere.
